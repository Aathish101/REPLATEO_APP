...
export default function ResalableClothes({ openDonationModal }) {
  return (
    <section className="page-section relative">
      ...
      <div className="page-container text-center">
        ...
        <div className="mx-auto max-w-md bg-[#C3E5E7] rounded-3xl shadow-xl p-10">
          <Shirt className="text-6xl mx-auto mb-6 text-[#4A7F84]" />

          <h2 className="text-2xl font-bold mb-3">START DONATION</h2>

          <p className="text-gray-700 mb-6">
            Donate clean, reusable clothing in good condition.
          </p>

          <button
            onClick={() => openDonationModal("clothes")}
